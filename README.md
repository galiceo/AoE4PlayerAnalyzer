...
1. 在 GitHub 仓库创建一个 Release
2. 把 `dist\AoE4PlayerAnalyzer.exe` 上传到 Release 附件
3. 让别人只下载 Release 里的 EXE

不建议长期把 EXE 直接提交到 git 仓库里，因为 EXE 是二进制大文件，后续每次更新都会让仓库变重。

## 功能

- 搜索 AoE4 玩家
- 输入玩家名 3 个字符后自动联想匹配玩家
